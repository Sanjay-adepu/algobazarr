    ...
    <>
      ...
      <section className="about-section">
        <div className="about-card">
          ...
          <p>
            AlgoBazarr was born out of a passion to bridge the gap between trading ideas and automated execution. Since July 2021, we’ve been dedicated to transforming trader concepts into fully automated strategies using the Tradetron platform.
          </p>
          <p>
          ...
          <p>
            At AlgoBazarr, our commitment is to support traders at every step—from concept to live deployment—ensuring a seamless and efficient algo trading experience.
          </p>
